...
app.use(cors({ origin: "http://localhost:3000", credentials: true }));    //prtocol, origin, host
...
app.use(function(req, res, next) {
  res.setHeader("Access-Control-Allow-Origin", "http://localhost:3000");        //res.setHeader<name,value>
...
app.post("/getPropertyImg", function(req, res, next) {
  ...
  var results = [];
  var startPath =
    "C:\\Users\\lenovo\\Desktop\\reactProjects\\HomeAway\\Backend\\public\\images\\" +
    req.body.id;
  if (req.body.id) {
...
app.post("/editprofile/save", function(req, res) {
  var startDate = "2018-09-23";
  var endDate = "2014-06-22";
  console.log("edit profile", JSON.stringify(req.body));
